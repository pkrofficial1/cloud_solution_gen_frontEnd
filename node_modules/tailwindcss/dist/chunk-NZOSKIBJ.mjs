...
`);console.warn(v)}}),o.value=Y(s)}),i.utilities.functional(t.slice(0,-2),o=>{let s=structuredClone(r),l=o.value,d=o.modifier;if(l===null)return;let u=!1,c=!1,m=!1,g=!1,h=new Map,w=!1;if(F([s],(v,{parent:A,replaceWith:k})=>{if(A?.kind!=="rule"&&A?.kind!=="at-rule"||v.kind!=="declaration"||!v.value)return;let b=G(v.value);(ee(b,(S,{replaceWith:R})=>{if(S.kind==="function"){if(S.value==="--value"){u=!0;let O=Zt(l,S,i);return O?(c=!0,O.ratio?w=!0:h.set(v,A),R(O.nodes),1):(u||=!1,k([]),2)}else if(S.value==="--modifier"){if(d===null)return k([]),2;m=!0;let O=Zt(d,S,i);return O?(g=!0,R(O.nodes),1):(m||=!1,k([]),2)}}})??0)===0&&(v.value=Y(b))}),u&&!c||m&&!g||w&&g||d&&!w&&!g)return null;if(w)for(let[v,A]of h){let k=A.nodes.indexOf(v);k!==-1&&A.nodes.splice(k,1)}return s.nodes}),i.utilities.suggest(t.slice(0,-2),()=>{let o=[],s=[];for(let[l,{literals:d,usedSpacingNumber:u,usedSpacingInteger:c,themeKeys:m}]of[[o,e["--value"]],[s,e["--modifier"]]]){for(let g of d)l.push(g);if(u)l.push(...Ge);else if(c)for(let g of Ge)E(g)&&l.push(g);for(let g of i.theme.keysInNamespaces(m))l.push(g.replace(Xt,(h,w,v)=>`${w}.${v}`))}return[{values:o,modifiers:s}]})}:si.test(t)?i=>{i.utilities.static(t,()=>structuredClone(r.nodes))}:null}function Zt(r,t,i){for(let e of t.nodes){if(r.kind==="named"&&e.kind==="word"&&(e.value[0]==="'"||e.value[0]==='"')&&e.value[e.value.length-1]===e.value[0]&&e.value.slice(1,-1)===r.value)return{nodes:G(r.value)};if(r.kind==="named"&&e.kind==="word"&&e.value[0]==="-"&&e.value[1]==="-"){let o=e.value;if(o.endsWith("-*")){o=o.slice(0,-2);let s=i.theme.resolve(r.value,[o]);if(s)return{nodes:G(s)}}else{let s=o.split("-*");if(s.length<=1)continue;let l=[s.shift()],d=i.theme.resolveWith(r.value,l,s);if(d){let[,u={}]=d;{let c=u[s.pop()];if(c)return{nodes:G(c)}}}}}else if(r.kind==="named"&&e.kind==="word"){if(!mt.includes(e.value))continue;let o=e.value==="ratio"&&"fraction"in r?r.fraction:r.value;if(!o)continue;let s=W(o,[e.value]);if(s===null)continue;if(s==="ratio"){let[l,d]=_(o,"/");if(!E(l)||!E(d))continue}else{if(s==="number"&&!de(o))continue;if(s==="percentage"&&!E(o.slice(0,-1)))continue}return{nodes:G(o),ratio:s==="ratio"}}else if(r.kind==="arbitrary"&&e.kind==="word"&&e.value[0]==="["&&e.value[e.value.length-1]==="]"){let o=e.value.slice(1,-1);if(o==="*")return{nodes:G(r.value)};if("dataType"in r&&r.dataType&&r.dataType!==o)continue;if("dataType"in r&&r.dataType)return{nodes:G(r.value)};if(W(r.value,[o])!==null)return{nodes:G(r.value)}}}}function le(r,t,i,e,o=""){let s=!1,l=Te(t,u=>i==null?e(u):u.startsWith("current")?e(J(u,i)):((u.startsWith("var(")||i.startsWith("var("))&&(s=!0),e(Qt(u,i))));function d(u){return o?_(u,",").map(c=>o+c).join(","):u}return s?[a(r,d(Te(t,e))),B("@supports (color: lab(from red l a b))",[a(r,d(l))])]:[a(r,d(l))]}function qe(r,t,i,e,o=""){let s=!1,l=_(t,",").map(d=>Te(d,u=>i==null?e(u):u.startsWith("current")?e(J(u,i)):((u.startsWith("var(")||i.startsWith("var("))&&(s=!0),e(Qt(u,i))))).map(d=>`drop-shadow(${d})`).join(" ");return s?[a(r,o+_(t,",").map(d=>`drop-shadow(${Te(d,e)})`).join(" ")),B("@supports (color: lab(from red l a b))",[a(r,o+l)])]:[a(r,o+l)]}var gt={"--alpha":fi,"--spacing":ci,"--theme":di,theme:pi};function fi(r,t,i,...e){let[o,s]=_(i,"/").map(l=>l.trim());if(!o||!s)throw new Error(`The --alpha(\u2026) function requires a color and an alpha value, e.g.: \`--alpha(${o||"var(--my-color)"} / ${s||"50%"})\``);if(e.length>0)throw new Error(`The --alpha(\u2026) function only accepts one argument, e.g.: \`--alpha(${o||"var(--my-color)"} / ${s||"50%"})\``);return J(o,s)}function ci(r,t,i,...e){if(!i)throw new Error("The --spacing(\u2026) function requires an argument, but received none.");if(e.length>0)throw new Error(`The --spacing(\u2026) function only accepts a single argument, but received ${e.length+1}.`);let o=r.theme.resolve(null,["--spacing"]);if(!o)throw new Error("The --spacing(\u2026) function requires that the `--spacing` theme variable exists, but it was not found.");return`calc(${o} * ${i})`}function di(r,t,i,...e){if(!i.startsWith("--"))throw new Error("The --theme(\u2026) function can only be used with CSS variables from your theme.");let o=!1;i.endsWith(" inline")&&(o=!0,i=i.slice(0,-7)),t.kind==="at-rule"&&(o=!0);let s=r.resolveThemeValue(i,o);if(!s){if(e.length>0)return e.join(", ");throw new Error(`Could not resolve value for theme function: \`theme(${i})\`. Consider checking if the variable name is correct or provide a fallback value to silence this error.`)}if(e.length===0)return s;let l=e.join(", ");if(l==="initial")return s;if(s==="initial")return l;if(s.startsWith("var(")||s.startsWith("theme(")||s.startsWith("--theme(")){let d=G(s);return gi(d,l),Y(d)}return s}function pi(r,t,i,...e){i=mi(i);let o=r.resolveThemeValue(i);if(!o&&e.length>0)return e.join(", ");if(!o)throw new Error(`Could not resolve value for theme function: \`theme(${i})\`. Consider checking if the path is correct or provide a fallback value to silence this error.`);return o}var rr=new RegExp(Object.keys(gt).map(r=>`${r}\\(`).join("|"));function be(r,t){let i=0;return F(r,e=>{if(e.kind==="declaration"&&e.value&&rr.test(e.value)){i|=8,e.value=ir(e.value,e,t);return}e.kind==="at-rule"&&(e.name==="@media"||e.name==="@custom-media"||e.name==="@container"||e.name==="@supports")&&rr.test(e.params)&&(i|=8,e.params=ir(e.params,e,t))}),i}function ir(r,t,i){let e=G(r);return ee(e,(o,{replaceWith:s})=>{if(o.kind==="function"&&o.value in gt){let l=_(Y(o.nodes).trim(),",").map(u=>u.trim()),d=gt[o.value](i,t,...l);return s(G(d))}}),Y(e)}function mi(r){if(r[0]!=="'"&&r[0]!=='"')return r;let t="",i=r[0];for(let e=1;e<r.length-1;e++){let o=r[e],s=r[e+1];o==="\\"&&(s===i||s==="\\")?(t+=s,e++):t+=o}return t}function gi(r,t){ee(r,i=>{if(i.kind==="function"&&!(i.value!=="var"&&i.value!=="theme"&&i.value!=="--theme"))if(i.nodes.length===1)i.nodes.push({kind:"word",value:`, ${t}`});else{let e=i.nodes[i.nodes.length-1];e.kind==="word"&&e.value==="initial"&&(e.value=t)}})}function Je(r,t){let i=r.length,e=t.length,o=i<e?i:e;for(let s=0;s<o;s++){let l=r.charCodeAt(s),d=t.charCodeAt(s);if(l>=48&&l<=57&&d>=48&&d<=57){let u=s,c=s+1,m=s,g=s+1;for(l=r.charCodeAt(c);l>=48&&l<=57;)l=r.charCodeAt(++c);for(d=t.charCodeAt(g);d>=48&&d<=57;)d=t.charCodeAt(++g);let h=r.slice(u,c),w=t.slice(m,g),v=Number(h)-Number(w);if(v)return v;if(h<w)return-1;if(h>w)return 1;continue}if(l!==d)return l-d}return r.length-t.length}var hi=/^\d+\/\d+$/;function nr(r){let t=[];for(let e of r.utilities.keys("static"))t.push({name:e,utility:e,fraction:!1,modifiers:[]});for(let e of r.utilities.keys("functional")){let o=r.utilities.getCompletions(e);for(let s of o)for(let l of s.values){let d=l!==null&&hi.test(l),u=l===null?e:`${e}-${l}`;t.push({name:u,utility:e,fraction:d,modifiers:s.modifiers}),s.supportsNegative&&t.push({name:`-${u}`,utility:`-${e}`,fraction:d,modifiers:s.modifiers})}}return t.length===0?[]:(t.sort((e,o)=>Je(e.name,o.name)),vi(t))}function vi(r){let t=[],i=null,e=new Map,o=new q(()=>[]);for(let l of r){let{utility:d,fraction:u}=l;i||(i={utility:d,items:[]},e.set(d,i)),d!==i.utility&&(t.push(i),i={utility:d,items:[]},e.set(d,i)),u?o.get(d).push(l):i.items.push(l)}i&&t[t.length-1]!==i&&t.push(i);for(let[l,d]of o){let u=e.get(l);u&&u.items.push(...d)}let s=[];for(let l of t)for(let d of l.items)s.push([d.name,{modifiers:d.modifiers}]);return s}function or(r){let t=[];for(let[e,o]of r.variants.entries()){let d=function({value:u,modifier:c}={}){let m=e;u&&(m+=s?`-${u}`:u),c&&(m+=`/${c}`);let g=r.parseVariant(m);if(!g)return[];let h=L(".__placeholder__",[]);if(xe(h,g,r.variants)===null)return[];let w=[];return We(h.nodes,(v,{path:A})=>{if(v.kind!=="rule"&&v.kind!=="at-rule"||v.nodes.length>0)return;A.sort((V,S)=>{let R=V.kind==="at-rule",O=S.kind==="at-rule";return R&&!O?-1:!R&&O?1:0});let k=A.flatMap(V=>V.kind==="rule"?V.selector==="&"?[]:[V.selector]:V.kind==="at-rule"?[`${V.name} ${V.params}`]:[]),b="";for(let V=k.length-1;V>=0;V--)b=b===""?k[V]:`${k[V]} { ${b} }`;w.push(b)}),w};var i=d;if(o.kind==="arbitrary")continue;let s=e!=="@",l=r.variants.getCompletions(e);switch(o.kind){case"static":{t.push({name:e,values:l,isArbitrary:!1,hasDash:s,selectors:d});break}case"functional":{t.push({name:e,values:l,isArbitrary:!0,hasDash:s,selectors:d});break}case"compound":{t.push({name:e,values:l,isArbitrary:!0,hasDash:s,selectors:d});break}}}return t}function ar(r,t){let{astNodes:i,nodeSorting:e}=ce(Array.from(t),r),o=new Map(t.map(l=>[l,null])),s=0n;for(let l of i){let d=e.get(l)?.candidate;d&&o.set(d,o.get(d)??s++)}return t.map(l=>[l,o.get(l)??null])}var He=/^@?[a-zA-Z0-9_-]*$/;var ht=class{compareFns=new Map;variants=new Map;completions=new Map;groupOrder=null;lastOrder=0;static(t,i,{compounds:e,order:o}={}){this.set(t,{kind:"static",applyFn:i,compoundsWith:0,compounds:e??2,order:o})}fromAst(t,i){let e=[];F(i,o=>{o.kind==="rule"?e.push(o.selector):o.kind==="at-rule"&&o.name!=="@slot"&&e.push(`${o.name} ${o.params}`)}),this.static(t,o=>{let s=structuredClone(i);vt(s,o.nodes),o.nodes=s},{compounds:we(e)})}functional(t,i,{compounds:e,order:o}={}){this.set(t,{kind:"functional",applyFn:i,compoundsWith:0,compounds:e??2,order:o})}compound(t,i,e,{compounds:o,order:s}={}){this.set(t,{kind:"compound",applyFn:e,compoundsWith:i,compounds:o??2,order:s})}group(t,i){this.groupOrder=this.nextOrder(),i&&this.compareFns.set(this.groupOrder,i),t(),this.groupOrder=null}has(t){return this.variants.has(t)}get(t){return this.variants.get(t)}kind(t){return this.variants.get(t)?.kind}compoundsWith(t,i){let e=this.variants.get(t),o=typeof i=="string"?this.variants.get(i):i.kind==="arbitrary"?{compounds:we([i.selector])}:this.variants.get(i.root);return!(!e||!o||e.kind!=="compound"||o.compounds===0||e.compoundsWith===0||(e.compoundsWith&o.compounds)===0)}suggest(t,i){this.completions.set(t,i)}getCompletions(t){return this.completions.get(t)?.()??[]}compare(t,i){if(t===i)return 0;if(t===null)return-1;if(i===null)return 1;if(t.kind==="arbitrary"&&i.kind==="arbitrary")return t.selector<i.selector?-1:1;if(t.kind==="arbitrary")return 1;if(i.kind==="arbitrary")return-1;let e=this.variants.get(t.root).order,o=this.variants.get(i.root).order,s=e-o;if(s!==0)return s;if(t.kind==="compound"&&i.kind==="compound"){let c=this.compare(t.variant,i.variant);return c!==0?c:t.modifier&&i.modifier?t.modifier.value<i.modifier.value?-1:1:t.modifier?1:i.modifier?-1:0}let l=this.compareFns.get(e);if(l!==void 0)return l(t,i);if(t.root!==i.root)return t.root<i.root?-1:1;let d=t.value,u=i.value;return d===null?-1:u===null||d.kind==="arbitrary"&&u.kind!=="arbitrary"?1:d.kind!=="arbitrary"&&u.kind==="arbitrary"||d.value<u.value?-1:1}keys(){return this.variants.keys()}entries(){return this.variants.entries()}set(t,{kind:i,applyFn:e,compounds:o,compoundsWith:s,order:l}){let d=this.variants.get(t);d?Object.assign(d,{kind:i,applyFn:e,compounds:o}):(l===void 0&&(this.lastOrder=this.nextOrder(),l=this.lastOrder),this.variants.set(t,{kind:i,applyFn:e,order:l,compoundsWith:s,compounds:o}))}nextOrder(){return this.groupOrder??this.lastOrder+1}};function we(r){let t=0;for(let i of r){if(i[0]==="@"){if(!i.startsWith("@media")&&!i.startsWith("@supports")&&!i.startsWith("@container"))return 0;t|=1;continue}if(i.includes("::"))return 0;t|=2}return t}function sr(r){let t=new ht;function i(c,m,{compounds:g}={}){g=g??we(m),t.static(c,h=>{h.nodes=m.map(w=>B(w,h.nodes))},{compounds:g})}i("*",[":is(& > *)"],{compounds:0}),i("**",[":is(& *)"],{compounds:0});function e(c,m){return m.map(g=>{g=g.trim();let h=_(g," ");return h[0]==="not"?h.slice(1).join(" "):c==="@container"?h[0][0]==="("?`not ${g}`:h[1]==="not"?`${h[0]} ${h.slice(2).join(" ")}`:`${h[0]} not ${h.slice(1).join(" ")}`:`not ${g}`})}let o=["@media","@supports","@container"];function s(c){for(let m of o){if(m!==c.name)continue;let g=_(c.params,",");return g.length>1?null:(g=e(c.name,g),I(c.name,g.join(", ")))}return null}function l(c){return c.includes("::")?null:`&:not(${_(c,",").map(g=>(g=g.replaceAll("&","*"),g)).join(", ")})`}t.compound("not",3,(c,m)=>{if(m.variant.kind==="arbitrary"&&m.variant.relative||m.modifier)return null;let g=!1;if(F([c],(h,{path:w})=>{if(h.kind!=="rule"&&h.kind!=="at-rule")return 0;if(h.nodes.length>0)return 0;let v=[],A=[];for(let b of w)b.kind==="at-rule"?v.push(b):b.kind==="rule"&&A.push(b);if(v.length>1)return 2;if(A.length>1)return 2;let k=[];for(let b of A){let V=l(b.selector);if(!V)return g=!1,2;k.push(L(V,[]))}for(let b of v){let V=s(b);if(!V)return g=!1,2;k.push(V)}return Object.assign(c,L("&",k)),g=!0,1}),c.kind==="rule"&&c.selector==="&"&&c.nodes.length===1&&Object.assign(c,c.nodes[0]),!g)return null}),t.suggest("not",()=>Array.from(t.keys()).filter(c=>t.compoundsWith("not",c))),t.compound("group",2,(c,m)=>{if(m.variant.kind==="arbitrary"&&m.variant.relative)return null;let g=m.modifier?`:where(.${r.prefix?`${r.prefix}\\:`:""}group\\/${m.modifier.value})`:`:where(.${r.prefix?`${r.prefix}\\:`:""}group)`,h=!1;if(F([c],(w,{path:v})=>{if(w.kind!=="rule")return 0;for(let k of v.slice(0,-1))if(k.kind==="rule")return h=!1,2;let A=w.selector.replaceAll("&",g);_(A,",").length>1&&(A=`:is(${A})`),w.selector=`&:is(${A} *)`,h=!0}),!h)return null}),t.suggest("group",()=>Array.from(t.keys()).filter(c=>t.compoundsWith("group",c))),t.compound("peer",2,(c,m)=>{if(m.variant.kind==="arbitrary"&&m.variant.relative)return null;let g=m.modifier?`:where(.${r.prefix?`${r.prefix}\\:`:""}peer\\/${m.modifier.value})`:`:where(.${r.prefix?`${r.prefix}\\:`:""}peer)`,h=!1;if(F([c],(w,{path:v})=>{if(w.kind!=="rule")return 0;for(let k of v.slice(0,-1))if(k.kind==="rule")return h=!1,2;let A=w.selector.replaceAll("&",g);_(A,",").length>1&&(A=`:is(${A})`),w.selector=`&:is(${A} ~ *)`,h=!0}),!h)return null}),t.suggest("peer",()=>Array.from(t.keys()).filter(c=>t.compoundsWith("peer",c))),i("first-letter",["&::first-letter"]),i("first-line",["&::first-line"]),i("marker",["& *::marker","&::marker","& *::-webkit-details-marker","&::-webkit-details-marker"]),i("selection",["& *::selection","&::selection"]),i("file",["&::file-selector-button"]),i("placeholder",["&::placeholder"]),i("backdrop",["&::backdrop"]),i("details-content",["&::details-content"]);{let c=function(){return D([I("@property","--tw-content",[a("syntax",'"*"'),a("initial-value",'""'),a("inherits","false")])])};var d=c;t.static("before",m=>{m.nodes=[L("&::before",[c(),a("content","var(--tw-content)"),...m.nodes])]},{compounds:0}),t.static("after",m=>{m.nodes=[L("&::after",[c(),a("content","var(--tw-content)"),...m.nodes])]},{compounds:0})}i("first",["&:first-child"]),i("last",["&:last-child"]),i("only",["&:only-child"]),i("odd",["&:nth-child(odd)"]),i("even",["&:nth-child(even)"]),i("first-of-type",["&:first-of-type"]),i("last-of-type",["&:last-of-type"]),i("only-of-type",["&:only-of-type"]),i("visited",["&:visited"]),i("target",["&:target"]),i("open",["&:is([open], :popover-open, :open)"]),i("default",["&:default"]),i("checked",["&:checked"]),i("indeterminate",["&:indeterminate"]),i("placeholder-shown",["&:placeholder-shown"]),i("autofill",["&:autofill"]),i("optional",["&:optional"]),i("required",["&:required"]),i("valid",["&:valid"]),i("invalid",["&:invalid"]),i("user-valid",["&:user-valid"]),i("user-invalid",["&:user-invalid"]),i("in-range",["&:in-range"]),i("out-of-range",["&:out-of-range"]),i("read-only",["&:read-only"]),i("empty",["&:empty"]),i("focus-within",["&:focus-within"]),t.static("hover",c=>{c.nodes=[L("&:hover",[I("@media","(hover: hover)",c.nodes)])]}),i("focus",["&:focus"]),i("focus-visible",["&:focus-visible"]),i("active",["&:active"]),i("enabled",["&:enabled"]),i("disabled",["&:disabled"]),i("inert",["&:is([inert], [inert] *)"]),t.compound("in",2,(c,m)=>{if(m.modifier)return null;let g=!1;if(F([c],(h,{path:w})=>{if(h.kind!=="rule")return 0;for(let v of w.slice(0,-1))if(v.kind==="rule")return g=!1,2;h.selector=`:where(${h.selector.replaceAll("&","*")}) &`,g=!0}),!g)return null}),t.suggest("in",()=>Array.from(t.keys()).filter(c=>t.compoundsWith("in",c))),t.compound("has",2,(c,m)=>{if(m.modifier)return null;let g=!1;if(F([c],(h,{path:w})=>{if(h.kind!=="rule")return 0;for(let v of w.slice(0,-1))if(v.kind==="rule")return g=!1,2;h.selector=`&:has(${h.selector.replaceAll("&","*")})`,g=!0}),!g)return null}),t.suggest("has",()=>Array.from(t.keys()).filter(c=>t.compoundsWith("has",c))),t.functional("aria",(c,m)=>{if(!m.value||m.modifier)return null;m.value.kind==="arbitrary"?c.nodes=[L(`&[aria-${lr(m.value.value)}]`,c.nodes)]:c.nodes=[L(`&[aria-${m.value.value}="true"]`,c.nodes)]}),t.suggest("aria",()=>["busy","checked","disabled","expanded","hidden","pressed","readonly","required","selected"]),t.functional("data",(c,m)=>{if(!m.value||m.modifier)return null;c.nodes=[L(`&[data-${lr(m.value.value)}]`,c.nodes)]}),t.functional("nth",(c,m)=>{if(!m.value||m.modifier||m.value.kind==="named"&&!E(m.value.value))return null;c.nodes=[L(`&:nth-child(${m.value.value})`,c.nodes)]}),t.functional("nth-last",(c,m)=>{if(!m.value||m.modifier||m.value.kind==="named"&&!E(m.value.value))return null;c.nodes=[L(`&:nth-last-child(${m.value.value})`,c.nodes)]}),t.functional("nth-of-type",(c,m)=>{if(!m.value||m.modifier||m.value.kind==="named"&&!E(m.value.value))return null;c.nodes=[L(`&:nth-of-type(${m.value.value})`,c.nodes)]}),t.functional("nth-last-of-type",(c,m)=>{if(!m.value||m.modifier||m.value.kind==="named"&&!E(m.value.value))return null;c.nodes=[L(`&:nth-last-of-type(${m.value.value})`,c.nodes)]}),t.functional("supports",(c,m)=>{if(!m.value||m.modifier)return null;let g=m.value.value;if(g===null)return null;if(/^[\w-]*\s*\(/.test(g)){let h=g.replace(/\b(and|or|not)\b/g," $1 ");c.nodes=[I("@supports",h,c.nodes)];return}g.includes(":")||(g=`${g}: var(--tw)`),(g[0]!=="("||g[g.length-1]!==")")&&(g=`(${g})`),c.nodes=[I("@supports",g,c.nodes)]},{compounds:1}),i("motion-safe",["@media (prefers-reduced-motion: no-preference)"]),i("motion-reduce",["@media (prefers-reduced-motion: reduce)"]),i("contrast-more",["@media (prefers-contrast: more)"]),i("contrast-less",["@media (prefers-contrast: less)"]);{let c=function(m,g,h,w){if(m===g)return 0;let v=w.get(m);if(v===null)return h==="asc"?-1:1;let A=w.get(g);return A===null?h==="asc"?1:-1:ve(v,A,h)};var u=c;{let m=r.namespace("--breakpoint"),g=new q(h=>{switch(h.kind){case"static":return r.resolveValue(h.root,["--breakpoint"])??null;case"functional":{if(!h.value||h.modifier)return null;let w=null;return h.value.kind==="arbitrary"?w=h.value.value:h.value.kind==="named"&&(w=r.resolveValue(h.value.value,["--breakpoint"])),!w||w.includes("var(")?null:w}case"arbitrary":case"compound":return null}});t.group(()=>{t.functional("max",(h,w)=>{if(w.modifier)return null;let v=g.get(w);if(v===null)return null;h.nodes=[I("@media",`(width < ${v})`,h.nodes)]},{compounds:1})},(h,w)=>c(h,w,"desc",g)),t.suggest("max",()=>Array.from(m.keys()).filter(h=>h!==null)),t.group(()=>{for(let[h,w]of r.namespace("--breakpoint"))h!==null&&t.static(h,v=>{v.nodes=[I("@media",`(width >= ${w})`,v.nodes)]},{compounds:1});t.functional("min",(h,w)=>{if(w.modifier)return null;let v=g.get(w);if(v===null)return null;h.nodes=[I("@media",`(width >= ${v})`,h.nodes)]},{compounds:1})},(h,w)=>c(h,w,"asc",g)),t.suggest("min",()=>Array.from(m.keys()).filter(h=>h!==null))}{let m=r.namespace("--container"),g=new q(h=>{switch(h.kind){case"functional":{if(h.value===null)return null;let w=null;return h.value.kind==="arbitrary"?w=h.value.value:h.value.kind==="named"&&(w=r.resolveValue(h.value.value,["--container"])),!w||w.includes("var(")?null:w}case"static":case"arbitrary":case"compound":return null}});t.group(()=>{t.functional("@max",(h,w)=>{let v=g.get(w);if(v===null)return null;h.nodes=[I("@container",w.modifier?`${w.modifier.value} (width < ${v})`:`(width < ${v})`,h.nodes)]},{compounds:1})},(h,w)=>c(h,w,"desc",g)),t.suggest("@max",()=>Array.from(m.keys()).filter(h=>h!==null)),t.group(()=>{t.functional("@",(h,w)=>{let v=g.get(w);if(v===null)return null;h.nodes=[I("@container",w.modifier?`${w.modifier.value} (width >= ${v})`:`(width >= ${v})`,h.nodes)]},{compounds:1}),t.functional("@min",(h,w)=>{let v=g.get(w);if(v===null)return null;h.nodes=[I("@container",w.modifier?`${w.modifier.value} (width >= ${v})`:`(width >= ${v})`,h.nodes)]},{compounds:1})},(h,w)=>c(h,w,"asc",g)),t.suggest("@min",()=>Array.from(m.keys()).filter(h=>h!==null)),t.suggest("@",()=>Array.from(m.keys()).filter(h=>h!==null))}}return i("portrait",["@media (orientation: portrait)"]),i("landscape",["@media (orientation: landscape)"]),i("ltr",['&:where(:dir(ltr), [dir="ltr"], [dir="ltr"] *)']),i("rtl",['&:where(:dir(rtl), [dir="rtl"], [dir="rtl"] *)']),i("dark",["@media (prefers-color-scheme: dark)"]),i("starting",["@starting-style"]),i("print",["@media print"]),i("forced-colors",["@media (forced-colors: active)"]),i("inverted-colors",["@media (inverted-colors: inverted)"]),i("pointer-none",["@media (pointer: none)"]),i("pointer-coarse",["@media (pointer: coarse)"]),i("pointer-fine",["@media (pointer: fine)"]),i("any-pointer-none",["@media (any-pointer: none)"]),i("any-pointer-coarse",["@media (any-pointer: coarse)"]),i("any-pointer-fine",["@media (any-pointer: fine)"]),i("noscript",["@media (scripting: none)"]),t}function lr(r){if(r.includes("=")){let[t,...i]=_(r,"="),e=i.join("=").trim();if(e[0]==="'"||e[0]==='"')return r;if(e.length>1){let o=e[e.length-1];if(e[e.length-2]===" "&&(o==="i"||o==="I"||o==="s"||o==="S"))return`${t}="${e.slice(0,-2)}" ${o}`}return`${t}="${e}"`}return r}function vt(r,t){F(r,(i,{replaceWith:e})=>{if(i.kind==="at-rule"&&i.name==="@slot")e(t);else if(i.kind==="at-rule"&&(i.name==="@keyframes"||i.name==="@property"))return Object.assign(i,D([I(i.name,i.params,i.nodes)])),1})}function ur(r){let t=er(r),i=sr(r),e=new q(u=>Jt(u,d)),o=new q(u=>Array.from(Gt(u,d))),s=new q(u=>{let c=fr(u,d);try{be(c.map(({node:m})=>m),d)}catch{return[]}return c}),l=new q(u=>{for(let c of Me(u))r.markUsedVariable(c)}),d={theme:r,utilities:t,variants:i,invalidCandidates:new Set,important:!1,candidatesToCss(u){let c=[];for(let m of u){let g=!1,{astNodes:h}=ce([m],this,{onInvalidCandidate(){g=!0}});h=he(h,d,0),h.length===0||g?c.push(null):c.push(re(h))}return c},getClassOrder(u){return ar(this,u)},getClassList(){return nr(this)},getVariants(){return or(this)},parseCandidate(u){return o.get(u)},parseVariant(u){return e.get(u)},compileAstNodes(u){return s.get(u)},getVariantOrder(){let u=Array.from(e.values());u.sort((h,w)=>this.variants.compare(h,w));let c=new Map,m,g=0;for(let h of u)h!==null&&(m!==void 0&&this.variants.compare(m,h)!==0&&g++,c.set(h,g),m=h);return c},resolveThemeValue(u,c=!0){let m=u.lastIndexOf("/"),g=null;m!==-1&&(g=u.slice(m+1).trim(),u=u.slice(0,m).trim());let h=r.resolve(null,[u],c?1:0)??void 0;return g&&h?J(h,g):h},trackUsedVariables(u){l.get(u)}};return d}var wt=["container-type","pointer-events","visibility","position","inset","inset-inline","inset-block","inset-inline-start","inset-inline-end","top","right","bottom","left","isolation","z-index","order","grid-column","grid-column-start","grid-column-end","grid-row","grid-row-start","grid-row-end","float","clear","--tw-container-component","margin","margin-inline","margin-block","margin-inline-start","margin-inline-end","margin-top","margin-right","margin-bottom","margin-left","box-sizing","display","field-sizing","aspect-ratio","height","max-height","min-height","width","max-width","min-width","flex","flex-shrink","flex-grow","flex-basis","table-layout","caption-side","border-collapse","border-spacing","transform-origin","translate","--tw-translate-x","--tw-translate-y","--tw-translate-z","scale","--tw-scale-x","--tw-scale-y","--tw-scale-z","rotate","--tw-rotate-x","--tw-rotate-y","--tw-rotate-z","--tw-skew-x","--tw-skew-y","transform","animation","cursor","touch-action","--tw-pan-x","--tw-pan-y","--tw-pinch-zoom","resize","scroll-snap-type","--tw-scroll-snap-strictness","scroll-snap-align","scroll-snap-stop","scroll-margin","scroll-margin-inline","scroll-margin-block","scroll-margin-inline-start","scroll-margin-inline-end","scroll-margin-top","scroll-margin-right","scroll-margin-bottom","scroll-margin-left","scroll-padding","scroll-padding-inline","scroll-padding-block","scroll-padding-inline-start","scroll-padding-inline-end","scroll-padding-top","scroll-padding-right","scroll-padding-bottom","scroll-padding-left","list-style-position","list-style-type","list-style-image","appearance","columns","break-before","break-inside","break-after","grid-auto-columns","grid-auto-flow","grid-auto-rows","grid-template-columns","grid-template-rows","flex-direction","flex-wrap","place-content","place-items","align-content","align-items","justify-content","justify-items","gap","column-gap","row-gap","--tw-space-x-reverse","--tw-space-y-reverse","divide-x-width","divide-y-width","--tw-divide-y-reverse","divide-style","divide-color","place-self","align-self","justify-self","overflow","overflow-x","overflow-y","overscroll-behavior","overscroll-behavior-x","overscroll-behavior-y","scroll-behavior","border-radius","border-start-radius","border-end-radius","border-top-radius","border-right-radius","border-bottom-radius","border-left-radius","border-start-start-radius","border-start-end-radius","border-end-end-radius","border-end-start-radius","border-top-left-radius","border-top-right-radius","border-bottom-right-radius","border-bottom-left-radius","border-width","border-inline-width","border-block-width","border-inline-start-width","border-inline-end-width","border-top-width","border-right-width","border-bottom-width","border-left-width","border-style","border-inline-style","border-block-style","border-inline-start-style","border-inline-end-style","border-top-style","border-right-style","border-bottom-style","border-left-style","border-color","border-inline-color","border-block-color","border-inline-start-color","border-inline-end-color","border-top-color","border-right-color","border-bottom-color","border-left-color","background-color","background-image","--tw-gradient-position","--tw-gradient-stops","--tw-gradient-via-stops","--tw-gradient-from","--tw-gradient-from-position","--tw-gradient-via","--tw-gradient-via-position","--tw-gradient-to","--tw-gradient-to-position","mask-image","--tw-mask-top","--tw-mask-top-from-color","--tw-mask-top-from-position","--tw-mask-top-to-color","--tw-mask-top-to-position","--tw-mask-right","--tw-mask-right-from-color","--tw-mask-right-from-position","--tw-mask-right-to-color","--tw-mask-right-to-position","--tw-mask-bottom","--tw-mask-bottom-from-color","--tw-mask-bottom-from-position","--tw-mask-bottom-to-color","--tw-mask-bottom-to-position","--tw-mask-left","--tw-mask-left-from-color","--tw-mask-left-from-position","--tw-mask-left-to-color","--tw-mask-left-to-position","--tw-mask-linear","--tw-mask-linear-position","--tw-mask-linear-from-color","--tw-mask-linear-from-position","--tw-mask-linear-to-color","--tw-mask-linear-to-position","--tw-mask-radial","--tw-mask-radial-shape","--tw-mask-radial-size","--tw-mask-radial-position","--tw-mask-radial-from-color","--tw-mask-radial-from-position","--tw-mask-radial-to-color","--tw-mask-radial-to-position","--tw-mask-conic","--tw-mask-conic-position","--tw-mask-conic-from-color","--tw-mask-conic-from-position","--tw-mask-conic-to-color","--tw-mask-conic-to-position","box-decoration-break","background-size","background-attachment","background-clip","background-position","background-repeat","background-origin","mask-composite","mask-mode","mask-type","mask-size","mask-clip","mask-position","mask-repeat","mask-origin","fill","stroke","stroke-width","object-fit","object-position","padding","padding-inline","padding-block","padding-inline-start","padding-inline-end","padding-top","padding-right","padding-bottom","padding-left","text-align","text-indent","vertical-align","font-family","font-size","line-height","font-weight","letter-spacing","text-wrap","overflow-wrap","word-break","text-overflow","hyphens","white-space","color","text-transform","font-style","font-stretch","font-variant-numeric","text-decoration-line","text-decoration-color","text-decoration-style","text-decoration-thickness","text-underline-offset","-webkit-font-smoothing","placeholder-color","caret-color","accent-color","color-scheme","opacity","background-blend-mode","mix-blend-mode","box-shadow","--tw-shadow","--tw-shadow-color","--tw-ring-shadow","--tw-ring-color","--tw-inset-shadow","--tw-inset-shadow-color","--tw-inset-ring-shadow","--tw-inset-ring-color","--tw-ring-offset-width","--tw-ring-offset-color","outline","outline-width","outline-offset","outline-color","--tw-blur","--tw-brightness","--tw-contrast","--tw-drop-shadow","--tw-grayscale","--tw-hue-rotate","--tw-invert","--tw-saturate","--tw-sepia","filter","--tw-backdrop-blur","--tw-backdrop-brightness","--tw-backdrop-contrast","--tw-backdrop-grayscale","--tw-backdrop-hue-rotate","--tw-backdrop-invert","--tw-backdrop-opacity","--tw-backdrop-saturate","--tw-backdrop-sepia","backdrop-filter","transition-property","transition-behavior","transition-delay","transition-duration","transition-timing-function","will-change","contain","content","forced-color-adjust"];function ce(r,t,{onInvalidCandidate:i}={}){let e=new Map,o=[],s=new Map;for(let d of r){if(t.invalidCandidates.has(d)){i?.(d);continue}let u=t.parseCandidate(d);if(u.length===0){i?.(d);continue}s.set(d,u)}let l=t.getVariantOrder();for(let[d,u]of s){let c=!1;for(let m of u){let g=t.compileAstNodes(m);if(g.length!==0){c=!0;for(let{node:h,propertySort:w}of g){let v=0n;for(let A of m.variants)v|=1n<<BigInt(l.get(A));e.set(h,{properties:w,variants:v,candidate:d}),o.push(h)}}}c||i?.(d)}return o.sort((d,u)=>{let c=e.get(d),m=e.get(u);if(c.variants-m.variants!==0n)return Number(c.variants-m.variants);let g=0;for(;g<c.properties.order.length&&g<m.properties.order.length&&c.properties.order[g]===m.properties.order[g];)g+=1;return(c.properties.order[g]??1/0)-(m.properties.order[g]??1/0)||m.properties.count-c.properties.count||Je(c.candidate,m.candidate)}),{astNodes:o,nodeSorting:e}}function fr(r,t){let i=wi(r,t);if(i.length===0)return[];let e=[],o=`.${se(r.raw)}`;for(let s of i){let l=yi(s);(r.important||t.important)&&dr(s);let d={kind:"rule",selector:o,nodes:s};for(let u of r.variants)if(xe(d,u,t.variants)===null)return[];e.push({node:d,propertySort:l})}return e}function xe(r,t,i,e=0){if(t.kind==="arbitrary"){if(t.relative&&e===0)return null;r.nodes=[B(t.selector,r.nodes)];return}let{applyFn:o}=i.get(t.root);if(t.kind==="compound"){let l=I("@slot");if(xe(l,t.variant,i,e+1)===null||t.root==="not"&&l.nodes.length>1)return null;for(let u of l.nodes)if(u.kind!=="rule"&&u.kind!=="at-rule"||o(u,t)===null)return null;F(l.nodes,u=>{if((u.kind==="rule"||u.kind==="at-rule")&&u.nodes.length<=0)return u.nodes=r.nodes,1}),r.nodes=l.nodes;return}if(o(r,t)===null)return null}function cr(r){let t=r.options?.types??[];return t.length>1&&t.includes("any")}function wi(r,t){if(r.kind==="arbitrary"){let l=r.value;return r.modifier&&(l=Z(l,r.modifier,t.theme)),l===null?[]:[[a(r.property,l)]]}let i=t.utilities.get(r.root)??[],e=[],o=i.filter(l=>!cr(l));for(let l of o){if(l.kind!==r.kind)continue;let d=l.compileFn(r);if(d!==void 0){if(d===null)return e;e.push(d)}}if(e.length>0)return e;let s=i.filter(l=>cr(l));for(let l of s){if(l.kind!==r.kind)continue;let d=l.compileFn(r);if(d!==void 0){if(d===null)return e;e.push(d)}}return e}function dr(r){for(let t of r)t.kind!=="at-root"&&(t.kind==="declaration"?t.important=!0:(t.kind==="rule"||t.kind==="at-rule")&&dr(t.nodes))}function yi(r){let t=new Set,i=0,e=r.slice(),o=!1;for(;e.length>0;){let s=e.shift();if(s.kind==="declaration"){if(s.value===void 0||(i++,o))continue;if(s.property==="--tw-sort"){let d=wt.indexOf(s.value??"");if(d!==-1){t.add(d),o=!0;continue}}let l=wt.indexOf(s.property);l!==-1&&t.add(l)}else if(s.kind==="rule"||s.kind==="at-rule")for(let l of s.nodes)e.push(l)}return{order:Array.from(t).sort((s,l)=>s-l),count:i}}function Re(r,t){let i=0,e=B("&",r),o=new Set,s=new q(()=>new Set),l=new q(()=>new Set);F([e],(g,{parent:h})=>{if(g.kind==="at-rule"){if(g.name==="@keyframes")return F(g.nodes,w=>{if(w.kind==="at-rule"&&w.name==="@apply")throw new Error("You cannot use `@apply` inside `@keyframes`.")}),1;if(g.name==="@utility"){let w=g.params.replace(/-\*$/,"");l.get(w).add(g),F(g.nodes,v=>{if(!(v.kind!=="at-rule"||v.name!=="@apply")){o.add(g);for(let A of pr(v,t))s.get(g).add(A)}});return}if(g.name==="@apply"){if(h===null)return;i|=1,o.add(h);for(let w of pr(g,t))s.get(h).add(w)}}});let d=new Set,u=[],c=new Set;function m(g,h=[]){if(!d.has(g)){if(c.has(g)){let w=h[(h.indexOf(g)+1)%h.length];throw g.kind==="at-rule"&&g.name==="@utility"&&w.kind==="at-rule"&&w.name==="@utility"&&F(g.nodes,v=>{if(v.kind!=="at-rule"||v.name!=="@apply")return;let A=v.params.split(/\s+/g);for(let k of A)for(let b of t.parseCandidate(k))switch(b.kind){case"arbitrary":break;case"static":case"functional":if(w.params.replace(/-\*$/,"")===b.root)throw new Error(`You cannot \`@apply\` the \`${k}\` utility here because it creates a circular dependency.`);break;default:}}),new Error(`Circular dependency detected:

${re([g])}
Relies on:

${re([w])}`)}c.add(g);for(let w of s.get(g))for(let v of l.get(w))h.push(g),m(v,h),h.pop();d.add(g),c.delete(g),u.push(g)}}for(let g of o)m(g);for(let g of u)if("nodes"in g)for(let h=0;h<g.nodes.length;h++){let w=g.nodes[h];if(w.kind!=="at-rule"||w.name!=="@apply")continue;let v=w.params.split(/\s+/g);{let A=ce(v,t,{onInvalidCandidate:b=>{throw new Error(`Cannot apply unknown utility class: ${b}`)}}).astNodes,k=[];for(let b of A)if(b.kind==="rule")for(let V of b.nodes)k.push(V);else k.push(b);g.nodes.splice(h,1,...k)}}return i}function*pr(r,t){for(let i of r.params.split(/\s+/g))for(let e of t.parseCandidate(i))switch(e.kind){case"arbitrary":break;case"static":case"functional":yield e.root;break;default:}}async function yt(r,t,i,e=0){let o=0,s=[];return F(r,(l,{replaceWith:d})=>{if(l.kind==="at-rule"&&(l.name==="@import"||l.name==="@reference")){let u=ki(G(l.params));if(u===null)return;l.name==="@reference"&&(u.media="reference"),o|=2;let{uri:c,layer:m,media:g,supports:h}=u;if(c.startsWith("data:")||c.startsWith("http://")||c.startsWith("https://"))return;let w=ne({},[]);return s.push((async()=>{if(e>100)throw new Error(`Exceeded maximum recursion depth while resolving \`${c}\` in \`${t}\`)`);let v=await i(c,t),A=me(v.content);await yt(A,v.base,i,e+1),w.nodes=bi([ne({base:v.base},A)],m,g,h)})()),d(w),1}}),s.length>0&&await Promise.all(s),o}function ki(r){let t,i=null,e=null,o=null;for(let s=0;s<r.length;s++){let l=r[s];if(l.kind!=="separator"){if(l.kind==="word"&&!t){if(!l.value||l.value[0]!=='"'&&l.value[0]!=="'")return null;t=l.value.slice(1,-1);continue}if(l.kind==="function"&&l.value.toLowerCase()==="url"||!t)return null;if((l.kind==="word"||l.kind==="function")&&l.value.toLowerCase()==="layer"){if(i)return null;if(o)throw new Error("`layer(\u2026)` in an `@import` should come before any other functions or conditions");"nodes"in l?i=Y(l.nodes):i="";continue}if(l.kind==="function"&&l.value.toLowerCase()==="supports"){if(o)return null;o=Y(l.nodes);continue}e=Y(r.slice(s));break}}return t?{uri:t,layer:i,media:e,supports:o}:null}function bi(r,t,i,e){let o=r;return t!==null&&(o=[I("@layer",t,o)]),i!==null&&(o=[I("@media",i,o)]),e!==null&&(o=[I("@supports",e[0]==="("?e:`(${e})`,o)]),o}function Ae(r,t=null){return Array.isArray(r)&&r.length===2&&typeof r[1]=="object"&&typeof r[1]!==null?t?r[1][t]??null:r[0]:Array.isArray(r)&&t===null?r.join(", "):typeof r=="string"&&t===null?r:null}function mr(r,{theme:t},i){for(let e of i){let o=Ye([e]);o&&r.theme.clearNamespace(`--${o}`,4)}for(let[e,o]of xi(t)){if(typeof o!="string"&&typeof o!="number")continue;if(typeof o=="string"&&(o=o.replace(/<alpha-value>/g,"1")),e[0]==="opacity"&&(typeof o=="number"||typeof o=="string")){let l=typeof o=="string"?parseFloat(o):o;l>=0&&l<=1&&(o=l*100+"%")}let s=Ye(e);s&&r.theme.add(`--${s}`,""+o,7)}if(Object.hasOwn(t,"fontFamily")){let e=5;{let o=Ae(t.fontFamily.sans);o&&r.theme.hasDefault("--font-sans")&&(r.theme.add("--default-font-family",o,e),r.theme.add("--default-font-feature-settings",Ae(t.fontFamily.sans,"fontFeatureSettings")??"normal",e),r.theme.add("--default-font-variation-settings",Ae(t.fontFamily.sans,"fontVariationSettings")??"normal",e))}{let o=Ae(t.fontFamily.mono);o&&r.theme.hasDefault("--font-mono")&&(r.theme.add("--default-mono-font-family",o,e),r.theme.add("--default-mono-font-feature-settings",Ae(t.fontFamily.mono,"fontFeatureSettings")??"normal",e),r.theme.add("--default-mono-font-variation-settings",Ae(t.fontFamily.mono,"fontVariationSettings")??"normal",e))}}return t}function xi(r){let t=[];return gr(r,[],(i,e)=>{if(Ci(i))return t.push([e,i]),1;if($i(i)){t.push([e,i[0]]);for(let o of Reflect.ownKeys(i[1]))t.push([[...e,`-${o}`],i[1][o]]);return 1}if(Array.isArray(i)&&i.every(o=>typeof o=="string"))return e[0]==="fontSize"?(t.push([e,i[0]]),i.length>=2&&t.push([[...e,"-line-height"],i[1]])):t.push([e,i.join(", ")]),1}),t}var Ai=/^[a-zA-Z0-9-_%/\.]+$/;function Ye(r){if(r[0]==="container")return null;r=structuredClone(r),r[0]==="animation"&&(r[0]="animate"),r[0]==="aspectRatio"&&(r[0]="aspect"),r[0]==="borderRadius"&&(r[0]="radius"),r[0]==="boxShadow"&&(r[0]="shadow"),r[0]==="colors"&&(r[0]="color"),r[0]==="containers"&&(r[0]="container"),r[0]==="fontFamily"&&(r[0]="font"),r[0]==="fontSize"&&(r[0]="text"),r[0]==="letterSpacing"&&(r[0]="tracking"),r[0]==="lineHeight"&&(r[0]="leading"),r[0]==="maxWidth"&&(r[0]="container"),r[0]==="screens"&&(r[0]="breakpoint"),r[0]==="transitionTimingFunction"&&(r[0]="ease");for(let t of r)if(!Ai.test(t))return null;return r.map((t,i,e)=>t==="1"&&i!==e.length-1?"":t).map(t=>t.replaceAll(".","_").replace(/([a-z])([A-Z])/g,(i,e,o)=>`${e}-${o.toLowerCase()}`)).filter((t,i)=>t!=="DEFAULT"||i!==r.length-1).join("-")}function Ci(r){return typeof r=="number"||typeof r=="string"}function $i(r){if(!Array.isArray(r)||r.length!==2||typeof r[0]!="string"&&typeof r[0]!="number"||r[1]===void 0||r[1]===null||typeof r[1]!="object")return!1;for(let t of Reflect.ownKeys(r[1]))if(typeof t!="string"||typeof r[1][t]!="string"&&typeof r[1][t]!="number")return!1;return!0}function gr(r,t=[],i){for(let e of Reflect.ownKeys(r)){let o=r[e];if(o==null)continue;let s=[...t,e],l=i(o,s)??0;if(l!==1){if(l===2)return 2;if(!(!Array.isArray(o)&&typeof o!="object")&&gr(o,s,i)===2)return 2}}}function Ze(r){let t=[];for(let i of _(r,".")){if(!i.includes("[")){t.push(i);continue}let e=0;for(;;){let o=i.indexOf("[",e),s=i.indexOf("]",o);if(o===-1||s===-1)break;o>e&&t.push(i.slice(e,o)),t.push(i.slice(o+1,s)),e=s+1}e<=i.length-1&&t.push(i.slice(e))}return t}function Ce(r){if(Object.prototype.toString.call(r)!=="[object Object]")return!1;let t=Object.getPrototypeOf(r);return t===null||Object.getPrototypeOf(t)===null}function Ke(r,t,i,e=[]){for(let o of t)if(o!=null)for(let s of Reflect.ownKeys(o)){e.push(s);let l=i(r[s],o[s],e);l!==void 0?r[s]=l:!Ce(r[s])||!Ce(o[s])?r[s]=o[s]:r[s]=Ke({},[r[s],o[s]],i,e),e.pop()}return r}function Qe(r,t,i){return function(o,s){let l=o.lastIndexOf("/"),d=null;l!==-1&&(d=o.slice(l+1).trim(),o=o.slice(0,l).trim());let u=(()=>{let c=Ze(o),[m,g]=Ni(r.theme,c),h=i(hr(t()??{},c)??null);if(typeof h=="string"&&(h=h.replace("<alpha-value>","1")),typeof m!="object")return typeof g!="object"&&g&4?h??m:m;if(h!==null&&typeof h=="object"&&!Array.isArray(h)){let w=Ke({},[h],(v,A)=>A);if(m===null&&Object.hasOwn(h,"__CSS_VALUES__")){let v={};for(let A in h.__CSS_VALUES__)v[A]=h[A],delete w[A];m=v}for(let v in m)v!=="__CSS_VALUES__"&&(h?.__CSS_VALUES__?.[v]&4&&hr(w,v.split("-"))!==void 0||(w[ge(v)]=m[v]));return w}if(Array.isArray(m)&&Array.isArray(g)&&Array.isArray(h)){let w=m[0],v=m[1];g[0]&4&&(w=h[0]??w);for(let A of Object.keys(v))g[1][A]&4&&(v[A]=h[1][A]??v[A]);return[w,v]}return m??h})();return d&&typeof u=="string"&&(u=J(u,d)),u??s}}function Ni(r,t){if(t.length===1&&t[0].startsWith("--"))return[r.get([t[0]]),r.getOptions(t[0])];let i=Ye(t),e=new Map,o=new q(()=>new Map),s=r.namespace(`--${i}`);if(s.size===0)return[null,0];let l=new Map;for(let[m,g]of s){if(!m||!m.includes("--")){e.set(m,g),l.set(m,r.getOptions(m?`--${i}-${m}`:`--${i}`));continue}let h=m.indexOf("--"),w=m.slice(0,h),v=m.slice(h+2);v=v.replace(/-([a-z])/g,(A,k)=>k.toUpperCase()),o.get(w===""?null:w).set(v,[g,r.getOptions(`--${i}${m}`)])}let d=r.getOptions(`--${i}`);for(let[m,g]of o){let h=e.get(m);if(typeof h!="string")continue;let w={},v={};for(let[A,[k,b]]of g)w[A]=k,v[A]=b;e.set(m,[h,w]),l.set(m,[d,v])}let u={},c={};for(let[m,g]of e)vr(u,[m??"DEFAULT"],g);for(let[m,g]of l)vr(c,[m??"DEFAULT"],g);return t[t.length-1]==="DEFAULT"?[u?.DEFAULT??null,c.DEFAULT??0]:"DEFAULT"in u&&Object.keys(u).length===1?[u.DEFAULT,c.DEFAULT??0]:(u.__CSS_VALUES__=c,[u,c])}function hr(r,t){for(let i=0;i<t.length;++i){let e=t[i];if(r?.[e]===void 0){if(t[i+1]===void 0)return;t[i+1]=`${e}-${t[i+1]}`;continue}r=r[e]}return r}function vr(r,t,i){for(let e of t.slice(0,-1))r[e]===void 0&&(r[e]={}),r=r[e];r[t[t.length-1]]=i}function Vi(r){return{kind:"combinator",value:r}}function Ti(r,t){return{kind:"function",value:r,nodes:t}}function Pe(r){return{kind:"selector",value:r}}function Si(r){return{kind:"separator",value:r}}function Ei(r){return{kind:"value",value:r}}function Oe(r,t,i=null){for(let e=0;e<r.length;e++){let o=r[e],s=!1,l=0,d=t(o,{parent:i,replaceWith(u){s||(s=!0,Array.isArray(u)?u.length===0?(r.splice(e,1),l=0):u.length===1?(r[e]=u[0],l=1):(r.splice(e,1,...u),l=u.length):(r[e]=u,l=1))}})??0;if(s){d===0?e--:e+=l-1;continue}if(d===2)return 2;if(d!==1&&o.kind==="function"&&Oe(o.nodes,t,o)===2)return 2}}function je(r){let t="";for(let i of r)switch(i.kind){case"combinator":case"selector":case"separator":case"value":{t+=i.value;break}case"function":t+=i.value+"("+je(i.nodes)+")"}return t}var wr=92,Ri=93,yr=41,Ki=58,kr=44,Pi=34,Oi=46,br=62,xr=10,ji=35,Ar=91,Cr=40,$r=43,_i=39,Nr=32,Vr=9,Tr=126;function Xe(r){r=r.replaceAll(`\r
`,`
`);let t=[],i=[],e=null,o="",s;for(let l=0;l<r.length;l++){let d=r.charCodeAt(l);switch(d){case kr:case br:case xr:case Nr:case $r:case Vr:case Tr:{if(o.length>0){let h=Pe(o);e?e.nodes.push(h):t.push(h),o=""}let u=l,c=l+1;for(;c<r.length&&(s=r.charCodeAt(c),!(s!==kr&&s!==br&&s!==xr&&s!==Nr&&s!==$r&&s!==Vr&&s!==Tr));c++);l=c-1;let m=r.slice(u,c),g=m.trim()===","?Si(m):Vi(m);e?e.nodes.push(g):t.push(g);break}case Cr:{let u=Ti(o,[]);if(o="",u.value!==":not"&&u.value!==":where"&&u.value!==":has"&&u.value!==":is"){let c=l+1,m=0;for(let h=l+1;h<r.length;h++){if(s=r.charCodeAt(h),s===Cr){m++;continue}if(s===yr){if(m===0){l=h;break}m--}}let g=l;u.nodes.push(Ei(r.slice(c,g))),o="",l=g,e?e.nodes.push(u):t.push(u);break}e?e.nodes.push(u):t.push(u),i.push(u),e=u;break}case yr:{let u=i.pop();if(o.length>0){let c=Pe(o);u.nodes.push(c),o=""}i.length>0?e=i[i.length-1]:e=null;break}case Oi:case Ki:case ji:{if(o.length>0){let u=Pe(o);e?e.nodes.push(u):t.push(u)}o=String.fromCharCode(d);break}case Ar:{if(o.length>0){let m=Pe(o);e?e.nodes.push(m):t.push(m)}o="";let u=l,c=0;for(let m=l+1;m<r.length;m++){if(s=r.charCodeAt(m),s===Ar){c++;continue}if(s===Ri){if(c===0){l=m;break}c--}}o+=r.slice(u,l+1);break}case _i:case Pi:{let u=l;for(let c=l+1;c<r.length;c++)if(s=r.charCodeAt(c),s===wr)c+=1;else if(s===d){l=c;break}o+=r.slice(u,l+1);break}case wr:{let u=r.charCodeAt(l+1);o+=String.fromCharCode(d)+String.fromCharCode(u),l+=1;break}default:o+=String.fromCharCode(d)}}return o.length>0&&t.push(Pe(o)),t}var Sr=/^[a-z@][a-zA-Z0-9/%._-]*$/;function kt({designSystem:r,ast:t,resolvedConfig:i,featuresRef:e,referenceMode:o}){let s={addBase(l){if(o)return;let d=oe(l);e.current|=be(d,r),t.push(I("@layer","base",d))},addVariant(l,d){if(!He.test(l))throw new Error(`\`addVariant('${l}')\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);typeof d=="string"||Array.isArray(d)?r.variants.static(l,u=>{u.nodes=Er(d,u.nodes)},{compounds:we(typeof d=="string"?[d]:d)}):typeof d=="object"&&r.variants.fromAst(l,oe(d))},matchVariant(l,d,u){function c(g,h,w){let v=d(g,{modifier:h?.value??null});return Er(v,w)}let m=Object.keys(u?.values??{});r.variants.group(()=>{r.variants.functional(l,(g,h)=>{if(!h.value){if(u?.values&&"DEFAULT"in u.values){g.nodes=c(u.values.DEFAULT,h.modifier,g.nodes);return}return null}if(h.value.kind==="arbitrary")g.nodes=c(h.value.value,h.modifier,g.nodes);else if(h.value.kind==="named"&&u?.values){let w=u.values[h.value.value];if(typeof w!="string")return;g.nodes=c(w,h.modifier,g.nodes)}})},(g,h)=>{if(g.kind!=="functional"||h.kind!=="functional")return 0;let w=g.value?g.value.value:"DEFAULT",v=h.value?h.value.value:"DEFAULT",A=u?.values?.[w]??w,k=u?.values?.[v]??v;if(u&&typeof u.sort=="function")return u.sort({value:A,modifier:g.modifier?.value??null},{value:k,modifier:h.modifier?.value??null});let b=m.indexOf(w),V=m.indexOf(v);return b=b===-1?m.length:b,V=V===-1?m.length:V,b!==V?b-V:A<k?-1:1})},addUtilities(l){l=Array.isArray(l)?l:[l];let d=l.flatMap(c=>Object.entries(c));d=d.flatMap(([c,m])=>_(c,",").map(g=>[g.trim(),m]));let u=new q(()=>[]);for(let[c,m]of d){if(c.startsWith("@keyframes ")){o||t.push(B(c,oe(m)));continue}let g=Xe(c),h=!1;if(Oe(g,w=>{if(w.kind==="selector"&&w.value[0]==="."&&Sr.test(w.value.slice(1))){let v=w.value;w.value="&";let A=je(g),k=v.slice(1),b=A==="&"?oe(m):[B(A,oe(m))];u.get(k).push(...b),h=!0,w.value=v;return}if(w.kind==="function"&&w.value===":not")return 1}),!h)throw new Error(`\`addUtilities({ '${c}' : \u2026 })\` defines an invalid utility selector. Utilities must be a single class name and start with a lowercase letter, eg. \`.scrollbar-none\`.`)}for(let[c,m]of u)r.theme.prefix&&F(m,g=>{if(g.kind==="rule"){let h=Xe(g.selector);Oe(h,w=>{w.kind==="selector"&&w.value[0]==="."&&(w.value=`.${r.theme.prefix}\\:${w.value.slice(1)}`)}),g.selector=je(h)}}),r.utilities.static(c,g=>{let h=structuredClone(m);return Rr(h,c,g.raw),e.current|=Re(h,r),h})},matchUtilities(l,d){let u=d?.type?Array.isArray(d?.type)?d.type:[d.type]:["any"];for(let[m,g]of Object.entries(l)){let h=function({negative:w}){return v=>{if(v.value?.kind==="arbitrary"&&u.length>0&&!u.includes("any")&&(v.value.dataType&&!u.includes(v.value.dataType)||!v.value.dataType&&!W(v.value.value,u)))return;let A=u.includes("color"),k=null,b=!1;{let R=d?.values??{};A&&(R=Object.assign({inherit:"inherit",transparent:"transparent",current:"currentcolor"},R)),v.value?v.value.kind==="arbitrary"?k=v.value.value:v.value.fraction&&R[v.value.fraction]?(k=R[v.value.fraction],b=!0):R[v.value.value]?k=R[v.value.value]:R.__BARE_VALUE__&&(k=R.__BARE_VALUE__(v.value)??null,b=(v.value.fraction!==null&&k?.includes("/"))??!1):k=R.DEFAULT??null}if(k===null)return;let V;{let R=d?.modifiers??null;v.modifier?R==="any"||v.modifier.kind==="arbitrary"?V=v.modifier.value:R?.[v.modifier.value]?V=R[v.modifier.value]:A&&!Number.isNaN(Number(v.modifier.value))?V=`${v.modifier.value}%`:V=null:V=null}if(v.modifier&&V===null&&!b)return v.value?.kind==="arbitrary"?null:void 0;A&&V!==null&&(k=J(k,V)),w&&(k=`calc(${k} * -1)`);let S=oe(g(k,{modifier:V}));return Rr(S,m,v.raw),e.current|=Re(S,r),S}};var c=h;if(!Sr.test(m))throw new Error(`\`matchUtilities({ '${m}' : \u2026 })\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter, eg. \`scrollbar\`.`);d?.supportsNegativeValues&&r.utilities.functional(`-${m}`,h({negative:!0}),{types:u}),r.utilities.functional(m,h({negative:!1}),{types:u}),r.utilities.suggest(m,()=>{let w=d?.values??{},v=new Set(Object.keys(w));v.delete("__BARE_VALUE__"),v.has("DEFAULT")&&(v.delete("DEFAULT"),v.add(null));let A=d?.modifiers??{},k=A==="any"?[]:Object.keys(A);return[{supportsNegative:d?.supportsNegativeValues??!1,values:Array.from(v),modifiers:k}]})}},addComponents(l,d){this.addUtilities(l,d)},matchComponents(l,d){this.matchUtilities(l,d)},theme:Qe(r,()=>i.theme??{},l=>l),prefix(l){return l},config(l,d){let u=i;if(!l)return u;let c=Ze(l);for(let m=0;m<c.length;++m){let g=c[m];if(u[g]===void 0)return d;u=u[g]}return u??d}};return s.addComponents=s.addComponents.bind(s),s.matchComponents=s.matchComponents.bind(s),s}function oe(r){let t=[];r=Array.isArray(r)?r:[r];let i=r.flatMap(e=>Object.entries(e));for(let[e,o]of i)if(typeof o!="object"){if(!e.startsWith("--")){if(o==="@slot"){t.push(B(e,[I("@slot")]));continue}e=e.replace(/([A-Z])/g,"-$1").toLowerCase()}t.push(a(e,String(o)))}else if(Array.isArray(o))for(let s of o)typeof s=="string"?t.push(a(e,s)):t.push(B(e,oe(s)));else o!==null&&t.push(B(e,oe(o)));return t}function Er(r,t){return(typeof r=="string"?[r]:r).flatMap(e=>{if(e.trim().endsWith("}")){let o=e.replace("}","{@slot}}"),s=me(o);return vt(s,t),s}else return B(e,t)})}function Rr(r,t,i){F(r,e=>{if(e.kind==="rule"){let o=Xe(e.selector);Oe(o,s=>{s.kind==="selector"&&s.value===`.${t}`&&(s.value=`.${se(i)}`)}),e.selector=je(o)}})}function Kr(r,t,i){for(let e of Ui(t))r.theme.addKeyframes(e)}function Ui(r){let t=[];if("keyframes"in r.theme)for(let[i,e]of Object.entries(r.theme.keyframes))t.push(I("@keyframes",i,oe(e)));return t}function Pr(r){return{theme:{...$t,colors:({theme:t})=>t("color",{}),extend:{fontSize:({theme:t})=>({...t("text",{})}),boxShadow:({theme:t})=>({...t("shadow",{})}),animation:({theme:t})=>({...t("animate",{})}),aspectRatio:({theme:t})=>({...t("aspect",{})}),borderRadius:({theme:t})=>({...t("radius",{})}),screens:({theme:t})=>({...t("breakpoint",{})}),letterSpacing:({theme:t})=>({...t("tracking",{})}),lineHeight:({theme:t})=>({...t("leading",{})}),transitionDuration:{DEFAULT:r.get(["--default-transition-duration"])??null},transitionTimingFunction:{DEFAULT:r.get(["--default-transition-timing-function"])??null},maxWidth:({theme:t})=>({...t("container",{})})}}}}var Ii={blocklist:[],future:{},prefix:"",important:!1,darkMode:null,theme:{},plugins:[],content:{files:[]}};function xt(r,t){let i={design:r,configs:[],plugins:[],content:{files:[]},theme:{},extend:{},result:structuredClone(Ii)};for(let o of t)bt(i,o);for(let o of i.configs)"darkMode"in o&&o.darkMode!==void 0&&(i.result.darkMode=o.darkMode??null),"prefix"in o&&o.prefix!==void 0&&(i.result.prefix=o.prefix??""),"blocklist"in o&&o.blocklist!==void 0&&(i.result.blocklist=o.blocklist??[]),"important"in o&&o.important!==void 0&&(i.result.important=o.important??!1);let e=zi(i);return{resolvedConfig:{...i.result,content:i.content,theme:i.theme,plugins:i.plugins},replacedThemeKeys:e}}function Fi(r,t){if(Array.isArray(r)&&Ce(r[0]))return r.concat(t);if(Array.isArray(t)&&Ce(t[0])&&Ce(r))return[r,...t];if(Array.isArray(t))return t}function bt(r,{config:t,base:i,path:e,reference:o}){let s=[];for(let u of t.plugins??[])"__isOptionsFunction"in u?s.push({...u(),reference:o}):"handler"in u?s.push({...u,reference:o}):s.push({handler:u,reference:o});if(Array.isArray(t.presets)&&t.presets.length===0)throw new Error("Error in the config file/plugin/preset. An empty preset (`preset: []`) is not currently supported.");for(let u of t.presets??[])bt(r,{path:e,base:i,config:u,reference:o});for(let u of s)r.plugins.push(u),u.config&&bt(r,{path:e,base:i,config:u.config,reference:!!u.reference});let l=t.content??[],d=Array.isArray(l)?l:l.files;for(let u of d)r.content.files.push(typeof u=="object"?u:{base:i,pattern:u});r.configs.push(t)}function zi(r){let t=new Set,i=Qe(r.design,()=>r.theme,o),e=Object.assign(i,{theme:i,colors:Ct});function o(s){return typeof s=="function"?s(e)??null:s??null}for(let s of r.configs){let l=s.theme??{},d=l.extend??{};for(let u in l)u!=="extend"&&t.add(u);Object.assign(r.theme,l);for(let u in d)r.extend[u]??=[],r.extend[u].push(d[u])}delete r.theme.extend;for(let s in r.extend){let l=[r.theme[s],...r.extend[s]];r.theme[s]=()=>{let d=l.map(o);return Ke({},d,Fi)}}for(let s in r.theme)r.theme[s]=o(r.theme[s]);if(r.theme.screens&&typeof r.theme.screens=="object")for(let s of Object.keys(r.theme.screens)){let l=r.theme.screens[s];l&&typeof l=="object"&&("raw"in l||"max"in l||"min"in l&&(r.theme.screens[s]=l.min))}return t}function Or(r,t){let i=r.theme.container||{};if(typeof i!="object"||i===null)return;let e=Li(i,t);e.length!==0&&t.utilities.static("container",()=>structuredClone(e))}function Li({center:r,padding:t,screens:i},e){let o=[],s=null;if(r&&o.push(a("margin-inline","auto")),(typeof t=="string"||typeof t=="object"&&t!==null&&"DEFAULT"in t)&&o.push(a("padding-inline",typeof t=="string"?t:t.DEFAULT)),typeof i=="object"&&i!==null){s=new Map;let l=Array.from(e.theme.namespace("--breakpoint").entries());if(l.sort((d,u)=>ve(d[1],u[1],"asc")),l.length>0){let[d]=l[0];o.push(I("@media",`(width >= --theme(--breakpoint-${d}))`,[a("max-width","none")]))}for(let[d,u]of Object.entries(i)){if(typeof u=="object")if("min"in u)u=u.min;else continue;s.set(d,I("@media",`(width >= ${u})`,[a("max-width",u)]))}}if(typeof t=="object"&&t!==null){let l=Object.entries(t).filter(([d])=>d!=="DEFAULT").map(([d,u])=>[d,e.theme.resolveValue(d,["--breakpoint"]),u]).filter(Boolean);l.sort((d,u)=>ve(d[1],u[1],"asc"));for(let[d,,u]of l)if(s&&s.has(d))s.get(d).nodes.push(a("padding-inline",u));else{if(s)continue;o.push(I("@media",`(width >= theme(--breakpoint-${d}))`,[a("padding-inline",u)]))}}if(s)for(let[,l]of s)o.push(l);return o}function jr({addVariant:r,config:t}){let i=t("darkMode",null),[e,o=".dark"]=Array.isArray(i)?i:[i];if(e==="variant"){let s;if(Array.isArray(o)||typeof o=="function"?s=o:typeof o=="string"&&(s=[o]),Array.isArray(s))for(let l of s)l===".dark"?(e=!1,console.warn('When using `variant` for `darkMode`, you must provide a selector.\nExample: `darkMode: ["variant", ".your-selector &"]`')):l.includes("&")||(e=!1,console.warn('When using `variant` for `darkMode`, your selector must contain `&`.\nExample `darkMode: ["variant", ".your-selector &"]`'));o=s}e===null||(e==="selector"?r("dark",`&:where(${o}, ${o} *)`):e==="media"?r("dark","@media (prefers-color-scheme: dark)"):e==="variant"?r("dark",o):e==="class"&&r("dark",`&:is(${o} *)`))}function _r(r){for(let[t,i]of[["t","top"],["tr","top right"],["r","right"],["br","bottom right"],["b","bottom"],["bl","bottom left"],["l","left"],["tl","top left"]])r.utilities.static(`bg-gradient-to-${t}`,()=>[a("--tw-gradient-position",`to ${i} in oklab`),a("background-image","linear-gradient(var(--tw-gradient-stops))")]);r.utilities.static("bg-left-top",()=>[a("background-position","left top")]),r.utilities.static("bg-right-top",()=>[a("background-position","right top")]),r.utilities.static("bg-left-bottom",()=>[a("background-position","left bottom")]),r.utilities.static("bg-right-bottom",()=>[a("background-position","right bottom")]),r.utilities.static("object-left-top",()=>[a("object-position","left top")]),r.utilities.static("object-right-top",()=>[a("object-position","right top")]),r.utilities.static("object-left-bottom",()=>[a("object-position","left bottom")]),r.utilities.static("object-right-bottom",()=>[a("object-position","right bottom")]),r.utilities.functional("max-w-screen",t=>{if(!t.value||t.value.kind==="arbitrary")return;let i=r.theme.resolve(t.value.value,["--breakpoint"]);if(i)return[a("max-width",i)]}),r.utilities.static("overflow-ellipsis",()=>[a("text-overflow","ellipsis")]),r.utilities.static("decoration-slice",()=>[a("-webkit-box-decoration-break","slice"),a("box-decoration-break","slice")]),r.utilities.static("decoration-clone",()=>[a("-webkit-box-decoration-break","clone"),a("box-decoration-break","clone")]),r.utilities.functional("flex-shrink",t=>{if(!t.modifier){if(!t.value)return[a("flex-shrink","1")];if(t.value.kind==="arbitrary")return[a("flex-shrink",t.value.value)];if(E(t.value.value))return[a("flex-shrink",t.value.value)]}}),r.utilities.functional("flex-grow",t=>{if(!t.modifier){if(!t.value)return[a("flex-grow","1")];if(t.value.kind==="arbitrary")return[a("flex-grow",t.value.value)];if(E(t.value.value))return[a("flex-grow",t.value.value)]}})}function Dr(r,t){let i=r.theme.screens||{},e=t.variants.get("min")?.order??0,o=[];for(let[l,d]of Object.entries(i)){let h=function(w){t.variants.static(l,v=>{v.nodes=[I("@media",g,v.nodes)]},{order:w})};var s=h;let u=t.variants.get(l),c=t.theme.resolveValue(l,["--breakpoint"]);if(u&&c&&!t.theme.hasDefault(`--breakpoint-${l}`))continue;let m=!0;typeof d=="string"&&(m=!1);let g=Mi(d);m?o.push(h):h(e)}if(o.length!==0){for(let[,l]of t.variants.variants)l.order>e&&(l.order+=o.length);t.variants.compareFns=new Map(Array.from(t.variants.compareFns).map(([l,d])=>(l>e&&(l+=o.length),[l,d])));for(let[l,d]of o.entries())d(e+l+1)}}function Mi(r){return(Array.isArray(r)?r:[r]).map(i=>typeof i=="string"?{min:i}:i&&typeof i=="object"?i:null).map(i=>{if(i===null)return null;if("raw"in i)return i.raw;let e="";return i.max!==void 0&&(e+=`${i.max} >= `),e+="width",i.min!==void 0&&(e+=` >= ${i.min}`),`(${e})`}).filter(Boolean).join(", ")}function Ur(r,t){let i=r.theme.aria||{},e=r.theme.supports||{},o=r.theme.data||{};if(Object.keys(i).length>0){let s=t.variants.get("aria"),l=s?.applyFn,d=s?.compounds;t.variants.functional("aria",(u,c)=>{let m=c.value;return m&&m.kind==="named"&&m.value in i?l?.(u,{...c,value:{kind:"arbitrary",value:i[m.value]}}):l?.(u,c)},{compounds:d})}if(Object.keys(e).length>0){let s=t.variants.get("supports"),l=s?.applyFn,d=s?.compounds;t.variants.functional("supports",(u,c)=>{let m=c.value;return m&&m.kind==="named"&&m.value in e?l?.(u,{...c,value:{kind:"arbitrary",value:e[m.value]}}):l?.(u,c)},{compounds:d})}if(Object.keys(o).length>0){let s=t.variants.get("data"),l=s?.applyFn,d=s?.compounds;t.variants.functional("data",(u,c)=>{let m=c.value;return m&&m.kind==="named"&&m.value in o?l?.(u,{...c,value:{kind:"arbitrary",value:o[m.value]}}):l?.(u,c)},{compounds:d})}}var Wi=/^[a-z]+$/;async function Fr({designSystem:r,base:t,ast:i,loadModule:e,sources:o}){let s=0,l=[],d=[];F(i,(g,{parent:h,replaceWith:w,context:v})=>{if(g.kind==="at-rule"){if(g.name==="@plugin"){if(h!==null)throw new Error("`@plugin` cannot be nested.");let A=g.params.slice(1,-1);if(A.length===0)throw new Error("`@plugin` must have a path.");let k={};for(let b of g.nodes??[]){if(b.kind!=="declaration")throw new Error(`Unexpected \`@plugin\` option:

${re([b])}

\`@plugin\` options must be a flat list of declarations.`);if(b.value===void 0)continue;let V=b.value,S=_(V,",").map(R=>{if(R=R.trim(),R==="null")return null;if(R==="true")return!0;if(R==="false")return!1;if(Number.isNaN(Number(R))){if(R[0]==='"'&&R[R.length-1]==='"'||R[0]==="'"&&R[R.length-1]==="'")return R.slice(1,-1);if(R[0]==="{"&&R[R.length-1]==="}")throw new Error(`Unexpected \`@plugin\` option: Value of declaration \`${re([b]).trim()}\` is not supported.

Using an object as a plugin option is currently only supported in JavaScript configuration files.`)}else return Number(R);return R});k[b.property]=S.length===1?S[0]:S}l.push([{id:A,base:v.base,reference:!!v.reference},Object.keys(k).length>0?k:null]),w([]),s|=4;return}if(g.name==="@config"){if(g.nodes.length>0)throw new Error("`@config` cannot have a body.");if(h!==null)throw new Error("`@config` cannot be nested.");d.push({id:g.params.slice(1,-1),base:v.base,reference:!!v.reference}),w([]),s|=4;return}}}),_r(r);let u=r.resolveThemeValue;if(r.resolveThemeValue=function(h,w){return h.startsWith("--")?u(h,w):(s|=Ir({designSystem:r,base:t,ast:i,sources:o,configs:[],pluginDetails:[]}),r.resolveThemeValue(h,w))},!l.length&&!d.length)return 0;let[c,m]=await Promise.all([Promise.all(d.map(async({id:g,base:h,reference:w})=>{let v=await e(g,h,"config");return{path:g,base:v.base,config:v.module,reference:w}})),Promise.all(l.map(async([{id:g,base:h,reference:w},v])=>{let A=await e(g,h,"plugin");return{path:g,base:A.base,plugin:A.module,options:v,reference:w}}))]);return s|=Ir({designSystem:r,base:t,ast:i,sources:o,configs:c,pluginDetails:m}),s}function Ir({designSystem:r,base:t,ast:i,sources:e,configs:o,pluginDetails:s}){let l=0,u=[...s.map(k=>{if(!k.options)return{config:{plugins:[k.plugin]},base:k.base,reference:k.reference};if("__isOptionsFunction"in k.plugin)return{config:{plugins:[k.plugin(k.options)]},base:k.base,reference:k.reference};throw new Error(`The plugin "${k.path}" does not accept options`)}),...o],{resolvedConfig:c}=xt(r,[{config:Pr(r.theme),base:t,reference:!0},...u,{config:{plugins:[jr]},base:t,reference:!0}]),{resolvedConfig:m,replacedThemeKeys:g}=xt(r,u),h=r.resolveThemeValue;r.resolveThemeValue=function(b,V){if(b[0]==="-"&&b[1]==="-")return h(b,V);let S=v.theme(b,void 0);if(Array.isArray(S)&&S.length===2)return S[0];if(Array.isArray(S))return S.join(", ");if(typeof S=="string")return S};let w={designSystem:r,ast:i,resolvedConfig:c,featuresRef:{set current(k){l|=k}}},v=kt({...w,referenceMode:!1}),A;for(let{handler:k,reference:b}of c.plugins)b?(A||=kt({...w,referenceMode:!0}),k(A)):k(v);if(mr(r,m,g),Kr(r,m,g),Ur(m,r),Dr(m,r),Or(m,r),!r.theme.prefix&&c.prefix){if(c.prefix.endsWith("-")&&(c.prefix=c.prefix.slice(0,-1),console.warn(`The prefix "${c.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only and is written as a variant before all utilities. We have fixed up the prefix for you. Remove the trailing \`-\` to silence this warning.`)),!Wi.test(c.prefix))throw new Error(`The prefix "${c.prefix}" is invalid. Prefixes must be lowercase ASCII letters (a-z) only.`);r.theme.prefix=c.prefix}if(!r.important&&c.important===!0&&(r.important=!0),typeof c.important=="string"){let k=c.important;F(i,(b,{replaceWith:V,parent:S})=>{if(b.kind==="at-rule"&&!(b.name!=="@tailwind"||b.params!=="utilities"))return S?.kind==="rule"&&S.selector===k?2:(V(L(k,[b])),2)})}for(let k of c.blocklist)r.invalidCandidates.add(k);for(let k of c.content.files){if("raw"in k)throw new Error(`Error in the config file/plugin/preset. The \`content\` key contains a \`raw\` entry:

${JSON.stringify(k,null,2)}

This feature is not currently supported.`);let b=!1;k.pattern[0]=="!"&&(b=!0,k.pattern=k.pattern.slice(1)),e.push({...k,negated:b})}return l}var zr=/^(-?\d+)\.\.(-?\d+)(?:\.\.(-?\d+))?$/;function et(r){let t=r.indexOf("{");if(t===-1)return[r];let i=[],e=r.slice(0,t),o=r.slice(t),s=0,l=o.lastIndexOf("}");for(let g=0;g<o.length;g++){let h=o[g];if(h==="{")s++;else if(h==="}"&&(s--,s===0)){l=g;break}}if(l===-1)throw new Error(`The pattern \`${r}\` is not balanced.`);let d=o.slice(1,l),u=o.slice(l+1),c;Bi(d)?c=qi(d):c=_(d,","),c=c.flatMap(g=>et(g));let m=et(u);for(let g of m)for(let h of c)i.push(e+h+g);return i}function Bi(r){return zr.test(r)}function qi(r){let t=r.match(zr);if(!t)return[r];let[,i,e,o]=t,s=o?parseInt(o,10):void 0,l=[];if(/^-?\d+$/.test(i)&&/^-?\d+$/.test(e)){let d=parseInt(i,10),u=parseInt(e,10);if(s===void 0&&(s=d<=u?1:-1),s===0)throw new Error("Step cannot be zero in sequence expansion.");let c=d<u;c&&s<0&&(s=-s),!c&&s>0&&(s=-s);for(let m=d;c?m<=u:m>=u;m+=s)l.push(m.toString())}return l}var Gi=/^[a-z]+$/,ut=(o=>(o[o.None=0]="None",o[o.AtProperty=1]="AtProperty",o[o.ColorMix=2]="ColorMix",o[o.All=3]="All",o))(ut||{});function Ji(){throw new Error("No `loadModule` function provided to `compile`")}function Hi(){throw new Error("No `loadStylesheet` function provided to `compile`")}function Yi(r){let t=0,i=null;for(let e of _(r," "))e==="reference"?t|=2:e==="inline"?t|=1:e==="default"?t|=4:e==="static"?t|=8:e.startsWith("prefix(")&&e.endsWith(")")&&(i=e.slice(7,-1));return[t,i]}var Se=(d=>(d[d.None=0]="None",d[d.AtApply=1]="AtApply",d[d.AtImport=2]="AtImport",d[d.JsPluginCompat=4]="JsPluginCompat",d[d.ThemeFunction=8]="ThemeFunction",d[d.Utilities=16]="Utilities",d[d.Variants=32]="Variants",d))(Se||{});async function Lr(r,{base:t="",loadModule:i=Ji,loadStylesheet:e=Hi}={}){let o=0;r=[ne({base:t},r)],o|=await yt(r,t,e);let s=null,l=new Le,d=[],u=[],c=null,m=null,g=[],h=[],w=[],v=[],A=null;F(r,(b,{parent:V,replaceWith:S,context:R})=>{if(b.kind==="at-rule"){if(b.name==="@tailwind"&&(b.params==="utilities"||b.params.startsWith("utilities"))){if(m!==null){S([]);return}let O=_(b.params," ");for(let U of O)if(U.startsWith("source(")){let P=U.slice(7,-1);if(P==="none"){A=P;continue}if(P[0]==='"'&&P[P.length-1]!=='"'||P[0]==="'"&&P[P.length-1]!=="'"||P[0]!=="'"&&P[0]!=='"')throw new Error("`source(\u2026)` paths must be quoted.");A={base:R.sourceBase??R.base,pattern:P.slice(1,-1)}}m=b,o|=16}if(b.name==="@utility"){if(V!==null)throw new Error("`@utility` cannot be nested.");if(b.nodes.length===0)throw new Error(`\`@utility ${b.params}\` is empty. Utilities should include at least one property.`);let O=tr(b);if(O===null)throw new Error(`\`@utility ${b.params}\` defines an invalid utility name. Utilities should be alphanumeric and start with a lowercase letter.`);u.push(O)}if(b.name==="@source"){if(b.nodes.length>0)throw new Error("`@source` cannot have a body.");if(V!==null)throw new Error("`@source` cannot be nested.");let O=!1,U=!1,P=b.params;if(P[0]==="n"&&P.startsWith("not ")&&(O=!0,P=P.slice(4)),P[0]==="i"&&P.startsWith("inline(")&&(U=!0,P=P.slice(7,-1)),P[0]==='"'&&P[P.length-1]!=='"'||P[0]==="'"&&P[P.length-1]!=="'"||P[0]!=="'"&&P[0]!=='"')throw new Error("`@source` paths must be quoted.");let H=P.slice(1,-1);if(U){let M=O?v:w,z=_(H," ");for(let te of z)for(let X of et(te))M.push(X)}else h.push({base:R.base,pattern:H,negated:O});S([]);return}if(b.name==="@variant"&&(V===null?b.nodes.length===0?b.name="@custom-variant":(F(b.nodes,O=>{if(O.kind==="at-rule"&&O.name==="@slot")return b.name="@custom-variant",2}),b.name==="@variant"&&g.push(b)):g.push(b)),b.name==="@custom-variant"){if(V!==null)throw new Error("`@custom-variant` cannot be nested.");S([]);let[O,U]=_(b.params," ");if(!He.test(O))throw new Error(`\`@custom-variant ${O}\` defines an invalid variant name. Variants should only contain alphanumeric, dashes or underscore characters.`);if(b.nodes.length>0&&U)throw new Error(`\`@custom-variant ${O}\` cannot have both a selector and a body.`);if(b.nodes.length===0){if(!U)throw new Error(`\`@custom-variant ${O}\` has no selector or body.`);let P=_(U.slice(1,-1),",");if(P.length===0||P.some(z=>z.trim()===""))throw new Error(`\`@custom-variant ${O} (${P.join(",")})\` selector is invalid.`);let H=[],M=[];for(let z of P)z=z.trim(),z[0]==="@"?H.push(z):M.push(z);d.push(z=>{z.variants.static(O,te=>{let X=[];M.length>0&&X.push(L(M.join(", "),te.nodes));for(let ae of H)X.push(B(ae,te.nodes));te.nodes=X},{compounds:we([...M,...H])})});return}else{d.push(P=>{P.variants.fromAst(O,b.nodes)});return}}if(b.name==="@media"){let O=_(b.params," "),U=[];for(let P of O)if(P.startsWith("source(")){let H=P.slice(7,-1);F(b.nodes,(M,{replaceWith:z})=>{if(M.kind==="at-rule"&&M.name==="@tailwind"&&M.params==="utilities")return M.params+=` source(${H})`,z([ne({sourceBase:R.base},[M])]),2})}else if(P.startsWith("theme(")){let H=P.slice(6,-1),M=H.includes("reference");F(b.nodes,z=>{if(z.kind!=="at-rule"){if(M)throw new Error('Files imported with `@import "\u2026" theme(reference)` must only contain `@theme` blocks.\nUse `@reference "\u2026";` instead.');return 0}if(z.name==="@theme")return z.params+=" "+H,1})}else if(P.startsWith("prefix(")){let H=P.slice(7,-1);F(b.nodes,M=>{if(M.kind==="at-rule"&&M.name==="@theme")return M.params+=` prefix(${H})`,1})}else P==="important"?s=!0:P==="